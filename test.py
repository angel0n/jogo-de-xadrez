...
bp = Piece('b', 'p', 'imgs/peaob.png')
wp = Piece('w', 'p', 'imgs/peaow.png')
bk = Piece('b', 'k', 'imgs/reib.png')
wk = Piece('w', 'k', 'imgs/reiw.png')
br = Piece('b', 'r', 'imgs/torreb.png')
wr = Piece('w', 'r', 'imgs/torrew.png')
bb = Piece('b', 'b', 'imgs/bispob.png')
wb = Piece('w', 'b', 'imgs/bispow.png')
bq = Piece('b', 'q', 'imgs/rainhab.png')
wq = Piece('w', 'q', 'imgs/rainhaw.png')
bkn = Piece('b', 'kn', 'imgs/cavalhob.png')
wkn = Piece('w', 'kn', 'imgs/cavalhow.png')
